...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <!-- <span class="hidden-xs"><i class="fa fa-user"></i> Profile</span> &nbsp;<i class="fa fa-caret-down"></i> -->
                <img src="../assets/img/avatar.jpg" class="w-14 h-auto ring ring-2 ring-gray-200 rounded-full p-2" alt="">
              </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kelas') {
                echo 'class="active"';
              } ?>>
          ...
          <li <?php if (isset($_GET['page']) && $_GET['page'] == 'history') {
                echo 'class="active"';
              } ?>>
            <a href="?page=history"><i class="fa fa-history"></i> <span>History Pemilihan</span></a>
          </li>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; TeamIT MIVHS</strong> All rights reserved.
    </footer>
